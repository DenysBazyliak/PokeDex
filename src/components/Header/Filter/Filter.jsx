...
const Filter = () => {
  ...
  return (
     <>
       <img width={30} height={30} alt={'filter'} src={'https://external-content.duckduckgo.com/iu/?u=http%3A%2F%2Fwww.freeiconspng.com%2Fuploads%2Ffilter-icon-1.png&f=1&nofb=1&ipt=ca09be8483c51f86aa93557550f9568b67f83dafdbf366eab1b1ceda1bdf31e8'} className={style.filterButton} onClick={() => handleShowFilter()}/>
